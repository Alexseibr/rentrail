...
export const companyWhiteLabelSettings = pgTable(
  "company_white_label_settings",
  {
...
export type CompanyWhiteLabelSettings =
  typeof companyWhiteLabelSettings.$inferSelect;
