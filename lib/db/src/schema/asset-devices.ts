...
export const assetDevices = pgTable("asset_devices", {
  ...
  index("asset_devices_company_asset_status_idx").on(t.companyId, t.assetId, t.status),
  index("asset_devices_company_device_status_idx").on(t.companyId, t.deviceId, t.status),
