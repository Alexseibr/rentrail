...
export const insertUserCompanyMembershipSchema = createInsertSchema(
...
export type InsertUserCompanyMembership = z.infer<
  typeof insertUserCompanyMembershipSchema
>;
