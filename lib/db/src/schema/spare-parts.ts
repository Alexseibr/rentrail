import { pgTable, uuid, varchar, text, timestamp, numeric, index, unique } from "drizzle-orm/pg-core";
...
export const spareParts = pgTable("spare_parts", {
  ...
  qtyInStock: numeric("qty_in_stock", { precision: 10, scale: 2 }).default("0").notNull(),
  minQtyAlert: numeric("min_qty_alert", { precision: 10, scale: 2 }).default("0").notNull(),
