...
export const telemetryEvents = pgTable("telemetry_events", {
  ...
  index("tevt_company_asset_recorded_idx").on(t.companyId, t.assetId, t.recordedAt),
  index("tevt_company_device_recorded_idx").on(t.companyId, t.deviceId, t.recordedAt),
