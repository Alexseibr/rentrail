...
export const companyBranding = pgTable(
  "company_branding",
  {
    ...
    publicShowStations: boolean("public_show_stations")
      .default(false)
      .notNull(),
    publicShowB2BForm: boolean("public_show_b2b_form").default(false).notNull(),
    publicShowInquiryForm: boolean("public_show_inquiry_form")
      .default(false)
      .notNull(),
  ...
  (t) => [index("company_branding_company_idx").on(t.companyId)],
);
