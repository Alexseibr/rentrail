import { pgTable, uuid, doublePrecision, integer, varchar, timestamp, jsonb, index } from "drizzle-orm/pg-core";
...
export const telemetrySnapshots = pgTable("telemetry_snapshots", {
  ...
  index("tsnap_company_device_recorded_idx").on(t.companyId, t.deviceId, t.recordedAt),
  index("tsnap_company_asset_recorded_idx").on(t.companyId, t.assetId, t.recordedAt),
