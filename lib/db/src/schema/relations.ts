...
export const userBranchMembershipsRelations = relations(
  userBranchMemberships,
  ({ one }) => ({
    user: one(users, {
      fields: [userBranchMemberships.userId],
      references: [users.id],
    }),
    company: one(companies, {
      fields: [userBranchMemberships.companyId],
      references: [companies.id],
    }),
    branch: one(branches, {
      fields: [userBranchMemberships.branchId],
      references: [branches.id],
    }),
    role: one(roles, {
      fields: [userBranchMemberships.roleId],
      references: [roles.id],
    }),
  }),
);
...
export const assetStatusHistoryRelations = relations(
  assetStatusHistory,
  ({ one }) => ({
    company: one(companies, {
      fields: [assetStatusHistory.companyId],
      references: [companies.id],
    }),
    asset: one(assets, {
    ...
    changedByUser: one(users, {
      fields: [assetStatusHistory.changedByUserId],
      references: [users.id],
    }),
  }),
);
...
export const rentalsRelations = relations(rentals, ({ one, many }) => ({
  ...
  rentalPlan: one(rentalPlans, {
    fields: [rentals.rentalPlanId],
    references: [rentalPlans.id],
  }),
  issuedByUser: one(users, {
    fields: [rentals.issuedByUserId],
    references: [users.id],
  }),
  returnedToStation: one(stations, {
    fields: [rentals.returnedToStationId],
    references: [stations.id],
  }),
...
export const rentalStatusHistoryRelations = relations(
  rentalStatusHistory,
  ({ one }) => ({
    company: one(companies, {
      fields: [rentalStatusHistory.companyId],
      references: [companies.id],
    }),
    rental: one(rentals, {
      fields: [rentalStatusHistory.rentalId],
      references: [rentals.id],
    }),
    changedByUser: one(users, {
      fields: [rentalStatusHistory.changedByUserId],
      references: [users.id],
    }),
  }),
);
...
export const depositsRelations = relations(deposits, ({ one }) => ({
  company: one(companies, {
    fields: [deposits.companyId],
    references: [companies.id],
  }),
  client: one(clients, {
    fields: [deposits.clientId],
    references: [clients.id],
  }),
  rental: one(rentals, {
    fields: [deposits.rentalId],
    references: [rentals.id],
  }),
}));
...
export const blacklistEntriesRelations = relations(
  ...
  ({ one }) => ({
    ...
    branch: one(branches, {
      fields: [blacklistEntries.branchId],
      references: [branches.id],
    }),
    client: one(clients, {
      fields: [blacklistEntries.clientId],
      references: [clients.id],
    }),
    createdByUser: one(users, {
      fields: [blacklistEntries.createdByUserId],
      references: [users.id],
    }),
  }),
);
...
export const inquiriesRelations = relations(inquiries, ({ one }) => ({
  ...
  branch: one(branches, {
    fields: [inquiries.branchId],
    references: [branches.id],
  }),
  station: one(stations, {
    fields: [inquiries.stationId],
    references: [stations.id],
  }),
  processedByUser: one(users, {
    fields: [inquiries.processedByUserId],
    references: [users.id],
  }),
  convertedClient: one(clients, {
    fields: [inquiries.convertedClientId],
    references: [clients.id],
  }),
  convertedRental: one(rentals, {
    fields: [inquiries.convertedRentalId],
    references: [rentals.id],
  }),
}));
...
export const b2bRequestsRelations = relations(b2bRequests, ({ one }) => ({
  company: one(companies, {
    fields: [b2bRequests.companyId],
    references: [companies.id],
  }),
  assignedToUser: one(users, {
    fields: [b2bRequests.assignedToUserId],
    references: [users.id],
  }),
  processedByUser: one(users, {
    fields: [b2bRequests.processedByUserId],
    references: [users.id],
  }),
}));
...
export const assetDevicesRelations = relations(assetDevices, ({ one }) => ({
  company: one(companies, {
    fields: [assetDevices.companyId],
    references: [companies.id],
  }),
  asset: one(assets, {
    fields: [assetDevices.assetId],
    references: [assets.id],
  }),
  device: one(devices, {
    fields: [assetDevices.deviceId],
    references: [devices.id],
  }),
}));

export const telemetrySnapshotsRelations = relations(
  telemetrySnapshots,
  ({ one }) => ({
    company: one(companies, {
      fields: [telemetrySnapshots.companyId],
      references: [companies.id],
    }),
    asset: one(assets, {
      fields: [telemetrySnapshots.assetId],
      references: [assets.id],
    }),
    device: one(devices, {
      fields: [telemetrySnapshots.deviceId],
      references: [devices.id],
    }),
  }),
);
...
export const telemetryEventsRelations = relations(
  ...
  ({ one }) => ({
    company: one(companies, {
      fields: [telemetryEvents.companyId],
      references: [companies.id],
    }),
    asset: one(assets, {
      fields: [telemetryEvents.assetId],
      references: [assets.id],
    }),
    device: one(devices, {
...
export const locationHistoryRelations = relations(
  ...
  ({ one }) => ({
    company: one(companies, {
      fields: [locationHistory.companyId],
      references: [companies.id],
    }),
    asset: one(assets, {
      fields: [locationHistory.assetId],
      references: [assets.id],
    }),
    device: one(devices, {
...
export const batteriesRelations = relations(batteries, ({ one, many }) => ({
  company: one(companies, {
    fields: [batteries.companyId],
    references: [companies.id],
  }),
  branch: one(branches, {
    fields: [batteries.branchId],
    references: [branches.id],
  }),
  station: one(stations, {
...
export const batteryAssignmentsRelations = relations(
  batteryAssignments,
  ({ one }) => ({
    company: one(companies, {
      fields: [batteryAssignments.companyId],
      references: [companies.id],
    }),
    battery: one(batteries, {
      fields: [batteryAssignments.batteryId],
      references: [batteries.id],
    }),
    asset: one(assets, {
      fields: [batteryAssignments.assetId],
      references: [assets.id],
    }),
    installedByUser: one(users, {
      fields: [batteryAssignments.installedByUserId],
      references: [users.id],
    }),
  }),
);
...
export const batteryEventsRelations = relations(batteryEvents, ({ one }) => ({
  company: one(companies, {
    fields: [batteryEvents.companyId],
    references: [companies.id],
  }),
  battery: one(batteries, {
    fields: [batteryEvents.batteryId],
    references: [batteries.id],
  }),
  asset: one(assets, {
    fields: [batteryEvents.assetId],
    references: [assets.id],
  }),
}));
...
export const geofencesRelations = relations(geofences, ({ one }) => ({
  company: one(companies, {
    fields: [geofences.companyId],
    references: [companies.id],
  }),
  branch: one(branches, {
    fields: [geofences.branchId],
    references: [branches.id],
  }),
  station: one(stations, {
    fields: [geofences.stationId],
    references: [stations.id],
  }),
}));
...
export const deviceCommandsRelations = relations(deviceCommands, ({ one }) => ({
  company: one(companies, {
    fields: [deviceCommands.companyId],
    references: [companies.id],
  }),
  asset: one(assets, {
    fields: [deviceCommands.assetId],
    references: [assets.id],
  }),
  device: one(devices, {
  ...
  requestedByUser: one(users, {
    fields: [deviceCommands.requestedByUserId],
    references: [users.id],
  }),
}));
...
export const providerApiKeysRelations = relations(
  ...
  ({ one }) => ({
    company: one(companies, {
      fields: [providerApiKeys.companyId],
      references: [companies.id],
    }),
  }),
);
...
export const platformUserRolesRelations = relations(
  platformUserRoles,
  ({ one }) => ({
    user: one(users, {
      fields: [platformUserRoles.userId],
      references: [users.id],
    }),
    platformRole: one(platformRoles, {
      fields: [platformUserRoles.platformRoleId],
      references: [platformRoles.id],
    }),
    grantedByUser: one(users, {
      fields: [platformUserRoles.grantedBy],
      references: [users.id],
    }),
  }),
);
...
export const platformAuditLogsRelations = relations(
  ...
  ({ one }) => ({
    ...
    targetCompany: one(companies, {
      fields: [platformAuditLogs.targetCompanyId],
      references: [companies.id],
    }),
  }),
);
...
export const serviceRequestsRelations = relations(
  ...
  ({ one, many }) => ({
    ...
    branch: one(branches, {
      fields: [serviceRequests.branchId],
      references: [branches.id],
    }),
    asset: one(assets, {
    ...
    reportedByUser: one(users, {
      fields: [serviceRequests.reportedByUserId],
      references: [users.id],
    }),
    assignedToUser: one(users, {
      fields: [serviceRequests.assignedToUserId],
      references: [users.id],
    }),
...
export const workOrdersRelations = relations(workOrders, ({ one }) => ({
  ...
  createdByUser: one(users, {
    fields: [workOrders.createdByUserId],
    references: [users.id],
  }),
}));
